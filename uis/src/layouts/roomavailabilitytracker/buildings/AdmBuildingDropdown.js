...
function AdmBuildingDropdown(props) {
  ...
  return (
    ...
    <Grid container>
      <Grid item xs={6}>
      <label value="Select Building: ">Select Inventory: </label>
      ...
      >
         ...
         <MenuItem>SoftWares</MenuItem>
         <MenuItem>Printers</MenuItem>
         <MenuItem>Mobile Devices</MenuItem>
         <MenuItem>Network Devices</MenuItem>
         <MenuItem>Map</MenuItem>
         <MenuItem>Other Assets</MenuItem>
        {/* {building.map((post) => {
          return (
            <MenuItem
